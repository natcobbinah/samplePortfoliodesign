...
function sampleProjectNames() {
  return [
    "Directional drilling calculator (also now an npm package)",
    ...
    "Braille Code Generator (npm package)",
    "Morse Code Generator (npm package)",
...
const sampleProjectImages = [
  ...
  `${https://www.npmjs.com/package/morse-code-generator}`,
  `${https://https://www.npmjs.com/package/braille-code-generator}`,
  ``,
